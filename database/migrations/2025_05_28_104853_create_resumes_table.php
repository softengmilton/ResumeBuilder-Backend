...
class Index extends Component
{
    ...
    {
        $this->educations[] = ['degree' => '', 'institution' => '', 'field_of_study' => '', 'start_date' => '', 'end_date' => ''];
    }
    ...
    public function submit()
    {
        $this->validate([
            ...
            'slug' => 'required|string|unique:resumes,slug',
        ...
        switch ($this->currentStep) {
            case 1:
                $rules = [
                    ...
                    'personal_info.summary' => 'required|string|min:100',
                ];
                break;
            case 2:
