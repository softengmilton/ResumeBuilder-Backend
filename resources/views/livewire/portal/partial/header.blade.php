<div>
    <header class="">
        <div class="Header_navigationSpacer__Cz_gN Header_navigationSpacerFull__O7P2g"></div>
        <nav id="nav-default container "
            ...
            <div class="flex flex-align-center flex-justify-space-between Header_logoContainer__Yn3b3">
                <a href="index.html" aria-label="Enhancv Logo" class="Header_logo__Forr8 navbar-logo-wrapper mobile-logo">
                    <svg id="logo" class="navbar-logo" xmlns="https://www.w3.org/2000/svg" width="143px"
                        ...
                        <g fill="#2DC08D">
                            ...
                            <path
                                d="M87.857,6.134c-1.457,0-2.766,0.63-3.682,1.627V3.422h-1.321v7.714v2.769v4.257h1.321v-4.257v-2.769 c0-2.029,1.651-3.681,3.682-3.681c2.029,0,3.682,1.652,3.682,3.681v7.025h1.32v-7.025C92.859,8.378,90.615,6.134,87.857,6.134">
                            </path>
                            <path
                                d="M113.445,6.134c-1.457,0-2.766,0.63-3.681,1.627V6.134h-1.321v5.002v0.661v6.364h1.321v-6.364v-0.661 c0-2.029,1.651-3.681,3.681-3.681c2.03,0,3.682,1.652,3.682,3.681v7.025h1.32v-7.025C118.447,8.378,116.203,6.134,113.445,6.134">
                            </path>
                            <path
                                d="M74.641,6.134c-1.457,0-2.766,0.63-3.682,1.627V6.134h-1.321v5.002v0.661v6.364h1.321v-6.364v-0.661 c0-2.029,1.652-3.681,3.682-3.681c2.03,0,3.682,1.652,3.682,3.681v7.025h1.32v-7.025C79.643,8.378,77.398,6.134,74.641,6.134">
                            </path>
                            <path
                            ...
                            <path
                                d="M141.645,6.134v5.017c0,0.988-0.387,1.916-1.094,2.617l-2.588,2.588l-2.59-2.59 c-0.703-0.697-1.092-1.627-1.092-2.615V6.134h-1.32v5.017c0,1.344,0.526,2.605,1.48,3.551l3.521,3.521l3.52-3.52 c0.957-0.948,1.482-2.209,1.482-3.553V6.134H141.645z">
                            </path>
                            <polygon
                                points="58.256,11.294 66.356,11.294 66.356,9.973 58.256,9.973 58.256,4.743 66.746,4.743 66.746,3.422 56.936,3.422 56.936,9.973 56.936,11.294 56.936,18.16 66.94,18.16 66.94,16.84 58.256,16.84 ">
                            </polygon>
                            <path
                ...
                <div class="Header_burgerMenu__UbzIt">
                    <div class="Header_burgerBar__xQvas"></div>
                    <div class="Header_burgerBar__xQvas"></div>
                    <div class="Header_burgerBar__xQvas"></div>
                </div>
            </div>
            <div class="flex flex-justify-space-between m-left-4 Header_menuContainer__4dHIe">
